...
-/
inductive prefix_expr (ℍ : Type) : context → ℕ → Type
| communicate {} {Γ} (a :  name Γ) (b : list (name Γ)) (y : ℕ) : prefix_expr Γ y
| spontanious {} {Γ} (k : ℍ) : prefix_expr Γ 0
